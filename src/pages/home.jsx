  ...
  const HeroSection = () => {
    ...
    return (
      <motion.div
        ...
        initial="hidden"
        whileInView="show"
        className="relative h-[calc(100vh-5rem)] md:h-screen"
      >
        ...
        <div className="absolute inset-0 bg-black bg-opacity-30 flex flex-col justify-end items-center pb-24 md:pb-32">
          <motion.h1
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 md:bottom-12">
          {images.map((_, index) => (
            <button
              key={index}
  ...
  const AboutUs = () => (
    ...
    >
      <div className="w-full mx-auto flex relative md:px-8 lg:px-12">
        ...
        <div className="absolute right-[4rem] top-[-3rem] w-[45vw] h-[400px] bg-gray-300 flex items-center justify-center shadow-lg md:right-[6rem] md:top-[-4rem] md:w-[40vw] md:h-[450px]"></div>
